                        ...
                        <div class="carousel-inner">
                            ...
                            @else
                                <div class="carousel-item active">
                                    <img src="{{ url('/') }}/{{ $product->photo }}" alt="{{ $product->name }}" class="d-block w-100" style="height: 600px; object-fit: cover; cursor: pointer;" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="openModal('{{ url('/') }}/{{ $product->photo }}', '0')">
                                </div>
                            @endif
                        </div>
                        <!-- Carousel Controls -->
