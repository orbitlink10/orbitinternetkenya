...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/') }}/resources/views/theme/branding/css/style.css">
    ...
    <style>
        ...
        :root {
            --theme-color: #1189A2;
            --theme-light: #66c2cc; /* Lighter variant for hover effects, gradients, etc. */
        }
        ...
        /* Override Bootstrap's btn-success for Account button */
        .btn-success {
