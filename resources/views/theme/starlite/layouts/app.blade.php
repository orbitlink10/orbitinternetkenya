...
<head>
    ...
    <title>
        @section('title') 
        {{ get_option('site_name', 'Starlite Internet Kenya') }} 
        @show
    </title>
    ...
    <meta property="og:site_name" content="{{ get_option('site_name', 'Starlite Internet Kenya') }}" />
    <meta property="og:type" content="@yield('og_type', 'website')" />

    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@yield('twitter_site', url('/'))" />
    <meta name="twitter:title" content="@yield('twitter_title', get_option('site_name', 'Starlite Internet Kenya'))" />
    ...
    <!-- Canonical URL -->
    @php
        $canonicalBase = rtrim(config('app.url') ?: 'https://starliteinternetkenya.co.ke', '/');
