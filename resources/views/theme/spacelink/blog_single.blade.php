...
@php
    $postExcerpt = Str::squish(strip_tags($post->meta_description ?: ($post->content ?? $post->title)));
    $postExcerpt = Str::limit($postExcerpt, 155, '');
@endphp
@section('title', ($post->meta_title ?? $post->title) . ' | Spacelink Kenya')
...
@section('twitter_description', Str::limit($postExcerpt, 200, ''))
