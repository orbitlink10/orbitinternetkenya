...
<footer class="bg-dark text-light pt-5">
    ...
    <div class="row g-4 pb-5">
      ...
      <div class="col-md-4">
        ...
        <ul class="list-unstyled mb-3">
          ...
          <li><i class="bi bi-clock-fill me-2"></i>Monâ€“Sat: 9AMâ€“6PM</li>
  ...
  <div class="bg-secondary text-center py-3">
    <div class="container">
      ...
      <p class="mb-0 small">
        <em>Disclaimer:</em> SpacelinkKenya.co is an independent specialist and not affiliated with Starlink.
      </p>
    </div>
  </div>
