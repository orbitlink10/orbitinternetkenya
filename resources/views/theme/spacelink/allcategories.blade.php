...
@php
    $allCategoriesMeta = \Illuminate\Support\Str::limit(
        \Illuminate\Support\Str::squish(strip_tags(get_option('hero_header_description') ?: 'Browse all categories for Starlink kits, networking accessories and installation services.')),
        155,
        ''
    );
@endphp
@section('meta_description', $allCategoriesMeta)
@section('main')
<section class="featured position-relative py-5">
    <div class="container">
        <h1 class="fw-bold mb-4">All Categories</h1>
        <div class="row g-4">
                    ...
                    <a href="{{ route('view_product_category', ['slug' => $category->slug]) }}" class="text-decoration-none text-dark">
                        <div class="card category-card border-0 shadow-sm h-100">
                            <div class="card-img-top position-relative overflow-hidden">
                                <img src="{{ $category->photo }}" alt="{{ $category->name }}" class="img-fluid w-100 h-100 object-fit-cover">
