...
@php
    $productsMeta = \Illuminate\Support\Str::squish(strip_tags(get_option('hero_header_description') ?: 'Browse our latest Starlink kits, networking gear and accessories with delivery across Kenya.'));
    $productsMeta = \Illuminate\Support\Str::limit($productsMeta, 155, '');
@endphp
@section('title') Products Listing @endsection
@section('meta_description', $productsMeta)
