...
@php
    $productExcerpt2 = \Illuminate\Support\Str::squish(strip_tags($product->meta_description ?: ($product->short_description ?? $product->name)));
    $productExcerpt2 = \Illuminate\Support\Str::limit($productExcerpt2, 155, '');
@endphp
@section('title', $product->meta_title ?: $product->name)
@section('meta_description', $productExcerpt2)
...
<div class="page-header breadcrumb-wrap">
    <div class="container">
        ...
        <h1 class="mt-3 fw-bold">{{ $product->name }}</h1>
    </div>
</div>
                    ...
                    <div class="tab-style3">
                        ...
                        <div class="tab-content shop_info_tab entry-main-content">
                            <div class="tab-pane fade show active" id="Description">
                                @php
                                    $prodDesc2 = $product->description;
                                    if ($prodDesc2) {
                                        $prodDesc2 = preg_replace('/<h1([^>]*)>/i', '<h2$1>', $prodDesc2);
                                        $prodDesc2 = preg_replace('/<\\/h1>/i', '</h2>', $prodDesc2);
                                    }
                                @endphp
                                <div>{!! $prodDesc2 !!}</div>
                            </div>
